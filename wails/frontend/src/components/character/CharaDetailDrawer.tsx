...
export const CharaDetailDrawer: FC<IProps> = ({ filePath }) => {
  return (
...
// 紧凑版角色信息组件
const CharaInfoCompact: FC<{ filePath: string }> = ({ filePath }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 'var(--spacing-md)' }}>
        ...
        <Space size={4} wrap>
          <Tag color="pink">可爱</Tag>
          <Tag color="cyan">少女</Tag>
          <Tag color="purple">古风</Tag>
